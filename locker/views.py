...
def print_detail(req):
    ...
    if req.method == "POST":
        ...
        # 고정 서비스 시작일 (09.01) 설정
        fixed_start_date = datetime(2026, 9, 1)
        if plan == "semester":
            # 2학기권(방학포함): 2026.09.01~2027.02.25 (약 6개월)
            fixed_end_date = datetime(2027, 2, 25)
            rental_period = 177  # 약 6개월
            base_price = 30000
        elif plan == "long":
            # 1년권: 2026.09.01~2027.08.28 (약 1년)
            fixed_end_date = datetime(2027, 8, 28)
